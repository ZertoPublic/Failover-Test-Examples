<#
.SYNOPSIS
This script is designed to stop a running Failover Test on an existing VPG.

.DESCRIPTION
This script can be used to schedule the stop of a running Failover Test, or remotely exectute the stopping of a Failover Test without accessing the Zerto GUI.
...
$CurrentLogDataFile = $LogDataDir + $CurrentMonth + "\FOT-Stop-Log-" + $CurrentTime + ".txt"
...
# Starting the FOT
################################################
$VPGSFOTURL = $BaseURL + "vpgs/" + $VPGIdentifier + "/FailoverTestStop"
